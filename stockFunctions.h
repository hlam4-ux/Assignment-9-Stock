 ...
 */
double highestValue(const std::vector<double>& values, int startDay,
                    int endDay);
 ...
 * @param csv comma-separated string of doubles (there will not be spaces
 * between)
 ...
 * Think in terms of "find the next comma, extract the substring up to that
 * comma" and repeat until done.
 *
 */
